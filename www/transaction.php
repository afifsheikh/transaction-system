    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a href="transaction.php" class="nav-link">Transaction</a></li>
    ...
    <section class="ftco-section contact-section">
      ...
      <?php
          ...
          //   session_unset($_SESSION["error"]);
            ...
            if(isset($_SESSION["successfullyOftrans"])){
              echo $_SESSION["successfullyOftrans"];
              unset($_SESSION['successfullyOftrans']);
          //   session_unset($_SESSION["error"]);
            }
          ?>
        <div class="row d-flex mb-5 contact-info justify-content-center">
        <div class="signup-form">
        <form action="testout.php" method="post">
		<h2>Transaction</h2>
		<p class="hint-text">Create a online transtion .</p>
        <div class="form-group">
        <input type="text" class="form-control" name="accountNumber" placeholder="Account Number" required="required">
        </div>
        <div class="form-group">
			<label class="checkbox-inline"><b>Name of the person from DB on behave of above accountNumber</b>  </label>
		</div>
        <div class="form-group">
        	<input type="text" class="form-control" name="amount" placeholder="Enter Amount" required="required">
        </div>
        <div class="form-group">
            <label for="comment">Reason of transfering:</label>
            <textarea class="form-control" rows="5" id="transfer" name="TransferMessage"></textarea>
        </div>
		...
		<div class="form-group">
            <button  type="submit" class="btn btn-success btn-lg btn-block">Proceed Now</button>
        </div>
    </form>
</div>
