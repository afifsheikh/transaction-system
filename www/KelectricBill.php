...
<html lang="en">
  <head>
    ...
    <script src="https://www.google.com/recaptcha/api.js?render=6LfT5LkUAAAAAMvPKZmfmqE_nJV2Vq6qEg-FK-QS"></script>
  ...
  <body>
    ...
    <section class="ftco-section contact-section">
      <div class="container">
		...
		<h2>Bill</h2>
		<p class="hint-text">Pay K-Electric Bill .</p>
        <div class="form-group">
        <input type="text" class="form-control" name="accountNumber" placeholder="Account Number" required="required">
        </div>
        <div class="form-group">
			<label class="checkbox-inline"><b>Total Amount of bill from K-Electric bill database </b>  </label>
		</div>
        <div class="form-group">
			<label class="checkbox-inline"><b>due date of bill from K-Electric bill database </b>  </label>
		</div>
        <div class="form-group">
        ...
        <div class="form-group">
        <div class="g-recaptcha" data-sitekey="6Lcy5rkUAAAAAK2opZd3wncQ0zKOKd0YYRGX3Vpc"></div>
        </div> 
        <div class="form-group">
          <div class="status">
          </div>
