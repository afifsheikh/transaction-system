  ...
  <body>
    ...
    <section class="ftco-section contact-section">
      <div class="container">
		...
		<h2>Bill</h2>
		<p class="hint-text">Pay Gass Bill .</p>
        <div class="form-group">
        <input type="text" class="form-control" name="accountNumber" placeholder="Account Number" required="required">
        </div>
        <div class="form-group">
			<label class="checkbox-inline"><b>Total Amount of bill from gass bill database </b>  </label>
		</div>
        <div class="form-group">
			<label class="checkbox-inline"><b>due date of bill from gass bill database </b>  </label>
		</div>
        <div class="form-group">
